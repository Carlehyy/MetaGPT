...
class ConsensusDetector:
    """Consensus detector - compatible interface"""

    def __init__(self, strategy="HYBRID"):
        self.strategy = strategy
        self.checker = ConsensusChecker()

    def check_consensus(self, messages, participants, current_round):
        """Check if consensus is reached"""
        result = self.checker.check_consensus(messages, participants, current_round)
        return result.reached, result.reason
